...
HD_PWD='C:/harman/vivado/works/basys3_24_2/basys3_24_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mobileRemoteRobotArm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_mobileRemoteRobotArm.tcl
