...
HD_PWD='C:/harman/vivado/works/basys3_24_2/basys3_24_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mobileRemoteRobotArm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_mobileRemoteRobotArm.tcl -notrace
