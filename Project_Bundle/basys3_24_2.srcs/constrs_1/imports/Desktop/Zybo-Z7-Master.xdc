...
# set_property -dict { PACKAGE_PIN Y11   IOSTANDARD LVCMOS33 } [get_ports { o_rgb_right[0] }]; #IO_L18N_T2_13 Sch=led5_r
# set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 } [get_ports { o_rgb_right[1] }]; #IO_L19P_T3_13 Sch=led5_g
# set_property -dict { PACKAGE_PIN Y12   IOSTANDARD LVCMOS33 } [get_ports { o_rgb_right[2] }]; #IO_L20P_T3_13 Sch=led5_b

# ##RGB LED 6
# set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { o_rgb_left[0] }]; #IO_L18P_T2_34 Sch=led6_r
# set_property -dict { PACKAGE_PIN F17   IOSTANDARD LVCMOS33 } [get_ports { o_rgb_left[1] }]; #IO_L6N_T0_VREF_35 Sch=led6_g
# set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { o_rgb_left[2] }]; #IO_L8P_T1_AD10P_35 Sch=led6_b
...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { CS }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { MOSI }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]         
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { MISO }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]        
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { SCLK }]; #IO_L11N_T1_SRCC_13 Sch=jb_n[2]        
