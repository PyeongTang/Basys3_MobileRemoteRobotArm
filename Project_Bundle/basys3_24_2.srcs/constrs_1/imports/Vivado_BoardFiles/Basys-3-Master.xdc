...
## Switches
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports {i_enable_sw}]
...
## LEDs
# set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports {o_led_v_status[0]}]
# set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS33 } [get_ports {o_led_v_status[1]}]
# set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports {o_led_v_status[2]}]
...
##Pmod Header JA
set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33} [get_ports {o_gripper_joint_pwm}];#Sch name = JA1
set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33} [get_ports {o_elbow_joint_pwm}];#Sch name = JA2
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33} [get_ports {o_shoulder_joint_pwm}];#Sch name = JA3
# set_property -dict { PACKAGE_PIN G2   IOSTANDARD LVCMOS33} [get_ports {o_joint_h_pwm}];#Sch name = JA4
# set_property -dict { PACKAGE_PIN H1   IOSTANDARD LVCMOS33 } [get_ports {o_joint_v_pwm}];#Sch name = JA7
# set_property -dict { PACKAGE_PIN K2   IOSTANDARD LVCMOS33 } [get_ports {o_joint_h_pwm}];#Sch name = JA8
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports {o_base_height_phase[0]}];#Sch name = JB1
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports {o_base_height_phase[1]}];#Sch name = JB2
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports {o_base_height_phase[2]}];#Sch name = JB3
set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports {o_base_height_phase[3]}];#Sch name = JB4
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports {o_base_rotation_pwm}];#Sch name = JB7
# set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports {o_ultra_m_trig}];#Sch name = JB8
# set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports {o_ultra_r_trig}];#Sch name = JB9
# set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports {}];#Sch name = JB10

##Pmod Header JC
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33}  [get_ports {i_rx}];#Sch name = JC1
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33}  [get_ports {o_tx}];#Sch name = JC2
# set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 PULLDOWN TRUE}  [get_ports {i_row[2]}];#Sch name = JC3
# set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 PULLDOWN TRUE}  [get_ports {i_row[3]}];#Sch name = JC4
# set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports {o_col[0]}];#Sch name = JC7
# set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports {o_col[1]}];#Sch name = JC8
...
##Pmod Header JXADC
# set_property -dict { PACKAGE_PIN J3   IOSTANDARD LVCMOS33 } [get_ports {i_adc_ch_6_p}];#Sch name = XA1_P
...
# set_property -dict { PACKAGE_PIN K3   IOSTANDARD LVCMOS33 } [get_ports {i_adc_ch_6_n}];#Sch name = XA1_N
